      ...
      <div className="w-full max-lg:mt-20 px-5 lg:px-10 z-[9] flex-col items-center flex justify-center ">
        ...
        <div className="w-full   py-5 flex justify-center items-center">
          ...
          <Link href="https://app.sourceblock.software" className=" flex justify-end">
            <ButtonViewAll
              title="Marketplace"
              className="hover:!bg-[#EEEEEE] !w-auto !py-3 !px-10  transition-colors duration-300 overflow-hidden !bg-transparent outline outline-1 outline-[#EEEEEE] !text-[#EEEEEE]  "
            />
          </Link>
        </div>
      </div>
